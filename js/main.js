...
const translations = {
  en: {
    ...
    'gallery.alt.8': 'Villa living room with sea view',
    'gallery.alt.9': 'Exterior view of the villa surrounded by the park',
    'gallery.alt.10': 'Sea view through the villa window',
    'gallery.alt.11': 'Panoramic view of the Punta Ala harbour',
